...
2. 勾选：
    ...
    ![开启WSL功能](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image.png)
3. 确认后重启电脑。
...
1. 打开 PowerShell（管理员），输入：
    ![打开PowerShell](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-1.png)
    ```powershell
    wsl --install
    ```
...
2. 找到并安装“Ubuntu”。
    ![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-4.png)
### 方法二：
- 由于主包的MsStore故障了，所以不得已采用第二种方法
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-2.png)
1. 进入Ubuntu官网下载WSL版本（网址：https://ubuntu.com/desktop/wsl）
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-3.png)
...
4. 回到`PowerShell`，导入`Ubuntu`系统镜像，输入命令：
    ...
    出现这样的页面即为安装成功
    ![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-5.png)
## 四、启动Ubuntu
1. **方法一**：开始菜单启动（简单快捷）
- 按下键盘上的 Win 键（或点击屏幕左下角的开始菜单）。
- 直接在搜索框输入 “Ubuntu” 或你安装时命名的发行版名称（如“Ubuntu-24.04”）。
- 出现“Ubuntu”应用后，点击它即可打开 Ubuntu 终端。
    ![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-6.png)
...
- 点击后会自动打开对应的 Linux 终端。
    ![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-7.png)
- 如果希望以后每次打开终端默认进入Ubuntu，可以设置一下默认配置文件为Ubuntu（如下图所示）
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-10.png)
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-11.png)
3. **方法三**：命令行启动
...
- 如果你有多个 WSL 发行版，输入如下命令启动指定的版本：
    ...
    ![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-8.png)
...
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-9.png)
这不是报错，而是一个“警告”或“提示”
...
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-12.png)
...
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-13.png)
- 选择左侧“入站规则”，右侧点“新建规则”。
- 选择“端口”，点“下一步”。
...
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-15.png)
#### 5.完成后在Ubuntu输入`curl -I google.com`验证，成功
![alt text](./imgs/2025-06-13-windows11-install-wsl-ubuntu24-04/image-14.png)
---
